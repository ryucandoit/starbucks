...
// 화면자체의 객체, lodash 사용 300은 0.3초 , 함수가 너무 자주 실행되는거 방지
...
// new는 생성자(클래스) new Swiper(선택자, 옵션)
...
floatingObject('.floating1', 1, 15); //딜레이 1초 위아래15px
...
spyEls.forEach(function (spyEl) {
  new ScrollMagic.Scene({
    ...
    triggerHook: 0.9, // 뷰포트를 세로로 0~1지점으로 나누었을때 어느부분에서 트리거가 걸리게 할지 설정
  })
